...
export const Footer = () => {
  return (
    <footer className="">
      ...
      <div className=""> */}
      <Container>
      <Text size='md' className='pb-6'>117 ​หมู่7​ บ้านดอนสบเปือ ต.เปือ อ.เชียงกลาง จ.น่าน theriverrunchiangklang@gmail.com </Text>
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="">
              ...
              <p>LIVE LIKE A LOCAL ,FEELS LIKE HOME,STAY AT THE RIVER RUNS.</p>
            </div>
            <div className="">
              <p className="mb-4">
      ...
      {/* <div>
              ...
              <p className="mb-4 flex items-center justify-center md:justify-start">
                ...
                117 ​หมู่ 7​ บ้านดอนสบเปือ ต.เปือ อ.เชียงกลาง จ.น่าน
              </p>
              <p className="mb-4 flex items-center justify-center md:justify-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
